...
export function SmokeOverlay({ className }: { className?: string }) {
  return (
    ...
    >
      <div
        className="absolute -left-1/4 top-1/4 h-[60vh] w-[60vh] rounded-full blur-[60px]"
        style={{
          background:
      ...
      />
      <div
        className="absolute right-0 top-0 h-[55vh] w-[55vh] rounded-full blur-[64px]"
        style={{
          background:
            "radial-gradient(circle, rgba(198,40,40,0.16), transparent 65%)",
          animation: "smoke-drift 20s ease-in-out 2s infinite",
          willChange: "transform, opacity",
        }}
      />
      <div
        className="absolute bottom-0 left-1/3 h-[50vh] w-[70vh] rounded-full blur-[72px]"
        style={{
          background:
            "radial-gradient(circle, rgba(249,168,38,0.1), transparent 70%)",
          animation: "smoke-drift 22s ease-in-out 1s infinite",
          willChange: "transform, opacity",
        }}
      />
    </div>
